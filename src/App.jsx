...
function App() {
  ...
  useEffect(() => {
    const handleKeyPress = (e) => {
      ...
      // スペースキーで再生/一時停止
      if (e.key === ' ' && !editingCell && videoPath) {
        e.preventDefault() // ページスクロールを防ぐ
        // 動画要素にフォーカスがある場合はブラウザのデフォルト動作を使用
  ...
  }, [platform, selectedChapter, selectedRows, lastSelectedRow, chapters, editingCell, videoPath, toggleVideoPlayPause])
    ...
    <div className={`app ${isDarkMode ? 'dark' : 'light'}`}>
      <div className="header">
        <MenuBar 
          ...
          rewind1Second={rewind1Second}
          advance1Second={advance1Second}
          platform={platform}
        />
